(function (window) {
	...
	mlPushMenu.prototype = {
		...
		_init() {
			...
			this.levels = [...this.element.getElementsByClassName(CLASS_LEVEL)];
			...
			this.levelBack = [
				...this.element.getElementsByClassName(this.options.backClass),
			];
		...
		_toggleLevels() {
			for (const levelEl of this.levels) {
				...
				} else if (levelEl.getAttribute('data-level') === this.level) {
